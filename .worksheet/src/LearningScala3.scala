object LearningScala3 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(225); 
  ...
  val result = transformInt(3, cubeIt);System.out.println("""result  : Int = """ + $show(result ));$skip(19); 
  ...
  transformInt(2, x => x / 2);System.out.println("""res1: Int = """ + $show(res$1));$skip(50); val res$2 = 
