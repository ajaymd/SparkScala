object LearningScala1 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(126); 
  ...
  val isBest: Boolean = picard == bestCaptain;System.out.println("""isBest  : Boolean = """ + $show(isBest ));$skip(319); 
  ...
  val doublePi = 2*piSinglePrecision;System.out.println("""doublePi  : Float = """ + $show(doublePi ));$skip(39); 
  println (f"Double pi $doublePi%.3f")}
